        ...
        children: [
          ...
          Column(
            children: [
              ...
              Text(VGCopy.locationTitle, style: boldTextStyle(color: appStore.isDarkModeOn ? Colors.white : bmSpecialColorDark), textAlign: TextAlign.center),
              16.height,
              Text(
                VGCopy.locationBody,
          ...
          Column(
            children: [
              AppButton(
                ...
                child: Text(VGCopy.continueLabel, style: boldTextStyle(color: Colors.white)),
              ...
              20.height,
              Text(VGCopy.notificationsSkip, style: boldTextStyle(color: appStore.isDarkModeOn ? bmPrimaryColor : Colors.grey)),
            ],
          )
        ],
      ).paddingAll(20),
