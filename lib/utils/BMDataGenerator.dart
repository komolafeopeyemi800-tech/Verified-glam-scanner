...
List<WalkThroughModelClass> getWalkThroughList() {
  ...
  list.add(WalkThroughModelClass(
    ...
    title: VGCopy.walkthrough1Title,
    subTitle: VGCopy.walkthrough1Subtitle,
  ));
  list.add(WalkThroughModelClass(
    image: 'images/model_two.jpg',
    title: VGCopy.walkthrough2Title,
    subTitle: VGCopy.walkthrough2Subtitle,
  ));
  list.add(WalkThroughModelClass(
    image: 'images/model_three.jpg',
    title: VGCopy.walkthrough3Title,
    subTitle: VGCopy.walkthrough3Subtitle,
  ));
